...
export default class ShoeShop extends Component {
    ...
    renderProductCard = () => {
        return this.shoes.map((product, index) => {
    ...
    render() {
        return (
            <div className="container-fluid">
                <div className="row">
                    <div className="col-4 d-flex align-items-center" style={{ minHeight: '300px' }}>
                        <nav>
                            <ul>
                                <li><a href="#">Home</a></li>
                    ...
                    <div className="col-8">
                        <h3 className="text-center display-8">Shoes List</h3>
                        <div className="row">
